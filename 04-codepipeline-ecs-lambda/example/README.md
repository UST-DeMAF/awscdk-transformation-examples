...
> `VpcStack`, `LambdaApisStack`, `EcsFargateStack`, `AsyncLambdasStack`, `rdsAuroraStack`.
...
`cdk.context.json` pins the availability zones for the placeholder account so `cdk synth` runs
